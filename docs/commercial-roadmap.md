...
- Live map with asset/tracker modes, live-first latest asset positions, tracker freshness states, clustering, focus behavior, interpolated timeline playback, range circles, and map query-string state.
